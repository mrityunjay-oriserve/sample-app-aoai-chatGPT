sample_user = {
  ...
  "Disguised-Host": "your_app_service.mrityunjay.site",
  "Host": "your_app_service.mrityunjay.site",
  "Max-Forwards": "10",
  "Origin": "https://your_app_service.mrityunjay.site",
  "Referer": "https://your_app_service.mrityunjay.site/",
  ...
  "Was-Default-Hostname": "your_app_service.mrityunjay.site",
  "X-Appservice-Proto": "https",
  "X-Arr-Log-Id": "4102b832-6c88-4c7c-8996-0edad9e4358f",
  "X-Arr-Ssl": "2048|256|CN=Microsoft Azure TLS Issuing CA 02, O=Microsoft Corporation, C=US|CN=*.mrityunjay.site, O=Microsoft Corporation, L=Redmond, S=WA, C=US",
